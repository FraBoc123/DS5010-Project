...
class MLSupportVectorClassifier:
    """Class that implements SVC classifier"""
    def __init__(self):
        """
        The constructor will initialize with columns and the oe hot encoder.
        """
        self.clf = SVC(random_state=10, kernel='rbf', C=10)
    ...
    def _transform_preprocessor(self, test_df):
        """
        Transforms testing Data into a one-hot-encoder on the testing
